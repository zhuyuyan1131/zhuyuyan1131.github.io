...
$('.js-74').attr('src', 'images/yingtao-120.png');
...
$('.js-74').attr('src', (dpi>1) ? 'images/yingtao-192.png' : 'images/yingtao-96.png');
...
$('.js-74').attr('src', (dpi>1) ? 'images/yingtao-64.png' : 'images/yingtao-32.png');
...
$('.js-78').attr('src', (dpi>1) ? 'images/yi-52.png' : 'images/yi-26.png');
