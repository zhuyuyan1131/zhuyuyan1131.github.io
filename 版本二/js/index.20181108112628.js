...
r=function(){if(thresholdPassed()){dpi=window.devicePixelRatio;if($(window).width()>=1200){$('.js').attr('src', (dpi>1) ? 'images/beijing-2400.png' : 'images/beijing-1200.png');
...
$('.js-7').attr('src', (dpi>1) ? 'images/tu-404.png' : 'images/tu-202.png');
...
$('.js-10').attr('src', (dpi>1) ? 'images/cat-1236.png' : 'images/cat-618.png');
$('.js-11').attr('src', (dpi>1) ? 'images/lvtiao-186.png' : 'images/lvtiao-93.png');
$('.js-12').attr('src', (dpi>1) ? 'images/sucai1-984.png' : 'images/sucai1-492.png');
...
$('.js-20').attr('src', (dpi>1) ? 'images/qq-112.png' : 'images/qq-56.png');}else if($(window).width()>=960){$('.js').attr('src', (dpi>1) ? 'images/beijing-1920.png' : 'images/beijing-960.png');
$('.js-2').attr('src', (dpi>1) ? 'images/sanjiao-52.png' : 'images/sanjiao-26.png');
...
$('.js-7').attr('src', (dpi>1) ? 'images/tu-322.png' : 'images/tu-161.png');
...
$('.js-10').attr('src', (dpi>1) ? 'images/cat-988.png' : 'images/cat-494.png');
$('.js-11').attr('src', (dpi>1) ? 'images/lvtiao-148.png' : 'images/lvtiao-74.png');
$('.js-12').attr('src', (dpi>1) ? 'images/sucai1-788.png' : 'images/sucai1-394.png');
...
$('.js-20').attr('src', (dpi>1) ? 'images/qq-90.png' : 'images/qq-45.png');}else{$('.js').attr('src', (dpi>1) ? 'images/beijing-640.png' : 'images/beijing-320.png');
...
$('.js-7').attr('src', (dpi>1) ? 'images/tu-108.png' : 'images/tu-54.png');
...
$('.js-10').attr('src', (dpi>1) ? 'images/cat-328.png' : 'images/cat-164.png');
$('.js-11').attr('src', (dpi>1) ? 'images/lvtiao-50.png' : 'images/lvtiao-25.png');
$('.js-12').attr('src', (dpi>1) ? 'images/sucai1-278.png' : 'images/sucai1-139.png');
